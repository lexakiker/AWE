<div class="content-container">
	...
	<div class="content-text">
		<table cellpadding="0" cellspacing="0" align="left" width="100%">
			<tr>
				...
				<td valign="top"><div class="content-ul">{shortstory}</div><td>
			</tr>
		</table>
		<div class="clearfix"></div>
	</div>
	<div class="content-footer">
		...
		<div class="right"><a href="{full-link}"><button class="e_button read" type="button">Читать полностью</button></a></div>
		<div class="clearfix"></div>
	</div>
</div>